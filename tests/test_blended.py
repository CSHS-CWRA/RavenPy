...
class TestBLENDED:
    def test_simple(self):
        ...
        params = (
            ...
            2.2111660e00,  # par_x02
            2.1662290e00,  # par_x03
            0.0002254976,  # feed 10**par_x04; not par_x4=-3.646858076
            2.1739760e01,  # par_x05
            1.5650910e00,  # par_x06
            6.2111460e00,  # par_x07
            9.313578e-01,  # par_x08
            3.486263e-02,  # par_x09
            0.2518350000,  # feed par_x09+x10; not par_x10=0.21697237
            0.0002279250,  # feed 10**par_x11; not par_x11=-3.642208036
            1.2143390e00,  # par_x12
            4.736668e-02,  # par_x13
            0.2070342000,  # feed par_x13+x14; not par_x14=0.15966752
            7.806324e-02,  # par_x15
            -1.336429e00,  # par_x16
            2.189741e-01,  # par_x17
            3.8456170e00,  # par_x18
            2.950022e-01,  # par_x19
            4.827523e-01,  # par_x20
            4.0998200e00,  # par_x21
            1.2831440e01,  # par_x22
            5.937894e-01,  # par_x23
            1.6515880e00,  # par_x24
            1.7058060000,  # feed par_x24+x25; not par_x25=0.054218
            ...
            -1.856108e00,  # par_x31
            2.3569950e00,  # par_x32
            1.0000000e00,  # par_x33
            1.0000000e00,  # par_x34
...
class TestBLENDED_OST:
    def test_simple(self):
        ...
        params = (
            ...
            -1.856108e00,  # par_x31
            2.3569950e00,  # par_x32
            1.1104960e00,  # par_x33
            1.0425560e00,  # par_x34
            7.510967e-03,  # par_x35
            5.321608e-01,  # par_r01
            2.891977e-02,  # par_r02
            9.605330e-01,  # par_r03
