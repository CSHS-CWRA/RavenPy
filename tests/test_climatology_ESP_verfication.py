...
from ravenpy.utilities.forecasting import make_ESP_hindcast_dataset, make_climpred_hindcast_object
...
class TestClimpredHindcastVerification:
    def test_simple(self):
        ...
        rank_histo_verif=hindcast_object.verify(metric='rank_histogram', comparison='m2o', dim=['member','init'], alignment='same_inits')     
