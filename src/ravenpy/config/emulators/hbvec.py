...
class HBVEC(Config):
    ...
    netcdf_attribute: dict[str, str] = Field({"model_id": "HBVEC"}, alias="NetCDFAttribute")
    ...
    rain_snow_transition: rc.RainSnowTransition = Field({"temp": P.X01, "delta": 2}, alias="RainSnowTransition")
    ...
    hru_state_variable_table: rc.HRUStateVariableTable = Field([{"hru_id": 1, "data": {"SOIL[2]": 0.50657}}])
